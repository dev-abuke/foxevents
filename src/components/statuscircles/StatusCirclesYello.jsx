...
const StatusCirclesYello = ({ data }) => {
  return (
    <div className="">
      <div className="relative sm:top-16 sm:pl-28 pl-0 mt-12">
        <div className="h-[104px] w-[104px] rounded-full bg-[#4BD6E4]  absolute" />
      ...
      <div className="grid md:h-[60rem] pb-16 sm:grid-cols-12 overflow-hidden mt-10">
        ...
        <div className="sm:self-center col-span-4">
          <div className="bg-[#FFF952] sm:ml-3 sm:w-[29.313rem] sm:h-[29.313rem] w-[18.75rem] h-[18.75rem] flex flex-col sm:pt-[8.063rem] pt-16 ml-0 mt-10 sm:pl-[6.25rem] pl-14 rounded-full">
          ...
          <div className="relative left-16 top-12 h-[104px] w-[104px] bg-[#FFF952] rounded-full hidden sm:block" />
        </div>
        {/* second middle circle */}
        <div className="text-black relative md:top-[60%] top-[190%] sm:h-96 sm:w-96 h-[19rem] w-[19rem] bg-[#FFF952] rounded-full sm:pl-0 pl-10 sm:pt-[5.875rem] pt-14 col-span-3">
        ...
        <div className="col-span-5">
          <div className="relative left-72 sm:left-0 bottom-56 sm:bottom-0 sm:top-72 h-[104px] w-[104px] md:w-40 md:h-40  bg-[#4BD6E4]  rounded-full" />
          <div className="sm:w-[43.43rem] sm:h-[43.43rem] w-96 h-96 bg-[#FFF952] flex flex-col md:pl-[6rem] pl-16 pt-20 rounded-full relative bottom-[18rem] sm:bottom-0 left-[15%]">
            <div className="sm:h-[9.5rem] hidden sm:block sm:w-[9.5rem] rounded-full bg-[#FFF952]relative top-[26%] right-[50%] -z-50" />
          ...
          <div className="relative bottom-[60%] h-20 w-20  bg-[#4BD6E4] rounded-full sm:hidden right-8" />
          <div className="lg:pl-[11rem] sm:pl-[8rem] pl-5 mt-16 lg:mt-4 space-y-2">
            <h2 className="text-xl font-bold">Made for you</h2>
            <p className="w-80 sm:w-56 lg:w-72">
...
export default StatusCirclesYello;
