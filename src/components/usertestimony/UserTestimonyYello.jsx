...
import blueqoute from "/assets/images/blueqoute.png";
...
const UserTestimonyYello = () => {
  // const items = [1, 2, 3];
  return (
    <div className="bg-[#FFF952] px-5 md:px-0 pt-11 md:pt-[6rem] md:pl-10 pb-10">
      <div className="">
      ...
      <div className="md:hidden pb-10 mt-10">
        <Carousel breakPoints={breakPoints} itemsToShow={1}>
          <div>
            ...
            <div className="mt-6">
              <img src={blueqoute} alt="qoute icon" />
              ...
              <p className="font-avenirblack text-base text-[#4BD6E4] mt-6">
                Adane Firde
              </p>
      ...
      <div className="md:grid md:grid-cols-3 gap-x-10 hidden md:block">
        {/* single card item */}
        ...
        {/* <div className="mt-0 col-span-1 hidden md:block relative bottom-32 sm:bottom-20 overflow-hidden">
          <div className="">
            <p className="font-avenirblack text-base text-[#4BD6E4]">
              Adane Firde
            </p>
            <p className="font-avenirnormal text-xs">Youthopians</p>
            <div className="flex gap-x-3 mt-7">
              <img src={blueqoute} alt="qoute icon" className="h-4" />
              <p className="font-avenirblack text-lg md:w-[26rem]">
                Working with Fox Events has been an absolute pleasure. As a
                company that specializes in events and promotions, we've had the
                opportunity to work with many clients over the years, but Fox
                Events stands out as one of the most delightful. We were
...
export default UserTestimonyYello;
