...
const IntroCard = ({ data }) => {
  return (
    <div className="flex">
      ...
      <div className="box1">
        <div className="xl:w-[20rem] md:w-[15rem] right-box xl:h-[14.2rem] sm:h-[11rem] bg-white rounded-r-2xl px-8 xl:pt-8 lg:pt-4 lg:pl-4">
          ...
          <div className="h-5">
            <p className="font-avenirnormal xl:text-sm xl:mt-5 lg:mt-2 lg:text-[10px]">
              {data.smallDes}
            </p>
          </div>
          ...
          <a
            href={data.link}
            target="_blank"
            className="bg-[#FFF952] flex xl:justify-center lg:justify-center xl:space-x-3 lg:space-x-2 xl:py-2 lg:py-1 rounded-full items-center xl:mt-8 lg:mt-5 xl:px-6  lg:w-52 xl:w-64 xl:ml-5"
          >
